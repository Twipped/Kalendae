...
(function(y){var q,h,m=function(a,b){if("function"===typeof document.addEventListener||d.isIE8()){var c=!1;try{c=a instanceof Element}catch(k){c=!!a&&1===c.nodeType}c||"string"===typeof a||(b=a);var e=this,f=e.classes,g=e.settings=d.merge(e.defaults,{attachTo:a},b||{}),c=e.container=d.make("div",{"class":f.container}),m=e.calendars=[],r=h().day(g.weekStart),p,s=[],l,n,q,t;l=[];var v;n=0;p=g.months;d.isIE8()&&d.addClassName(c,"ie8");for(n=7;n--;)s.push(r.format(g.columnHeaderFormat)),r.add("days",
1);x(e);if("object"===typeof g.subscribe)for(n in g.subscribe)g.subscribe.hasOwnProperty(n)&&e.subscribe(n,g.subscribe[n]);e._sel=[];g.selected&&e.setSelected(g.selected,!1);p=g.viewStartDate?h(g.viewStartDate,g.format):0<e._sel.length?h(e._sel[0]):h();e.viewStartDate=p.date(1);(p={past:g.months-1,"today-past":g.months-1,any:2<g.months?Math.floor(g.months/2):0,"today-future":0,future:0}[this.settings.direction])&&h().month()==h(e.viewStartDate).month()&&(e.viewStartDate=h(e.viewStartDate).subtract({M:p}).date(1));
if("function"===typeof g.blackout)e.blackout=g.blackout;else if(g.blackout){var w=u(g.blackout,g.parseSplitDelimiter,g.format);e.blackout=function(a){a=h(a).yearDay();if(1>a||!e._sel)return!1;for(var c=w.length;c--;)if(w[c].yearDay()===a)return!0;return!1}}else e.blackout=function(){return!1};e.direction=e.directions[g.direction]?e.directions[g.direction]:e.directions.any;for(p=Math.max(g.months,1);p--;){l=d.make("div",{"class":f.calendar},c);l.setAttribute("data-cal-index",p);1<g.months&&(p==Math.max(g.months-
1,1)?d.addClassName(l,f.monthFirst):0===p?d.addClassName(l,f.monthLast):d.addClassName(l,f.monthMiddle));n=d.make("div",{"class":f.title},l);g.useYearNav||d.addClassName(n,f.disableYearNav);d.make("a",{"class":f.previousYear},n);d.make("a",{"class":f.previousMonth},n);d.make("a",{"class":f.nextYear},n);d.make("a",{"class":f.nextMonth},n);r=d.make("span",{"class":f.caption},n);q=d.make("div",{"class":f.header},l);n=0;do v=d.make("span",{},q),v.innerHTML=s[n];while(7>++n);q=d.make("div",{"class":f.days},
l);n=0;l=[];do"week"==g.mode?(0==n%7&&(t=d.make("div",{"class":f.week+" clearfix"},q),l.push(t)),d.make("span",{},t)):l.push(d.make("span",{},q));while(42>++n);m.push({caption:r,days:l});p&&d.make("div",{"class":f.monthSeparator},c)}e.draw();d.addEvent(c,"mousedown",function(a,c){var b;if(d.hasClassName(c,f.nextMonth))e.disableNext||!1===e.publish("view-changed",e,["next-month"])||(e.viewStartDate.add("months",1),e.draw());else if(d.hasClassName(c,f.previousMonth))e.disablePreviousMonth||!1===e.publish("view-changed",
...
this._sel=[a]:a.yearDay()>this._sel[0].yearDay()?this._sel[1]=a:this._sel=[a,this._sel[0]];break;default:this._sel=[a]}this._sel.sort(function(a,b){return a.yearDay()-b.yearDay()});this.publish("change",this,[a]);!1!==b&&this.draw();return!0},weekSelected:function(a){var b=a.toDate(),c=h(b).startOf("week"),b=h(b).endOf("week").subtract("day",1);this._sel=[c,b];this.publish("change",this,[a.day()]);this.draw()},makeSelectedDateVisible:function(a){outOfViewMonth=h(a).date("1").diff(this.viewStartDate,
"months");0>outOfViewMonth?this.viewStartDate.subtract("months",1):0<outOfViewMonth&&outOfViewMonth>=this.settings.months&&this.viewStartDate.add("months",1)},removeSelected:function(a,b){a=h(a,this.settings.format).hours(12);for(var c=this._sel.length;c--;)if(this._sel[c].yearDay()===a.yearDay())return this._sel.splice(c,1),this.publish("change",this,[a]),!1!==b&&this.draw(),!0;return!1},draw:function(){var a=h(this.viewStartDate).hours(12),b,c=this.classes,k,e,f,g=0,m,r=0,p,s,l=this.settings;m=
this.calendars.length;do{b=h(a).date(1);b.day(b.day()<this.settings.weekStart?this.settings.weekStart-7:this.settings.weekStart);k=this.calendars[g];k.caption.innerHTML=a.format(this.settings.titleFormat);p=r=0;do"week"==l.mode?(0==r%7&&0!=r&&p++,e=k.days[p].childNodes[r%7]):e=k.days[r],f=[],(s=this.isSelected(b))&&f.push({"-1":c.dayInRange,1:c.daySelected,"true":c.daySelected}[s]),b.month()!=a.month()?f.push(c.dayOutOfMonth):f.push(c.dayInMonth),(!(this.blackout(b)||this.direction(b)||b.month()!=
a.month()&&!1===l.dayOutOfMonthClickable)||0<s)&&f.push(c.dayActive),b.yearDay()===q.yearDay()&&f.push(c.dayToday),s=b.format(this.settings.dayAttributeFormat),l.dateClassMap[s]&&f.push(l.dateClassMap[s]),e.innerHTML=b.format(l.dayNumberFormat),e.className=f.join(" "),e.setAttribute("data-date",s),b.add("days",1);while(42>++r);a.add("months",1)}while(++g<m);if(l.directionScrolling){if("today-past"===l.direction||"past"===l.direction)b=a.add({m:1}).diff(h(),"months",!0),0>=b?(this.disableNextMonth=
!1,d.removeClassName(this.container,c.disableNextMonth)):(this.disableNextMonth=!0,d.addClassName(this.container,c.disableNextMonth));else if("today-future"===l.direction||"future"===l.direction)b=a.subtract({m:1}).diff(h(),"months",!0),b>l.months?(this.disablePreviousMonth=!1,d.removeClassName(this.container,c.disablePreviousMonth)):(this.disablePreviousMonth=!0,d.addClassName(this.container,c.disablePreviousMonth));if("today-past"===l.direction||"past"===l.direction)b=a.add({m:12}).diff(h(),"months",
!0),-11>=b?(this.disableNextYear=!1,d.removeClassName(this.container,c.disableNextYear)):(this.disableNextYear=!0,d.addClassName(this.container,c.disableNextYear));else if("today-future"===l.direction||"future"===l.direction)b=a.subtract({m:12}).diff(h(),"months",!0),b>11+l.months?(this.disablePreviousYear=!1,d.removeClassName(this.container,c.disablePreviousYear)):(this.disablePreviousYear=!0,d.addClassName(this.container,c.disablePreviousYear))}}};var u=function(a,b,c){var k=[];"string"===typeof a?
a=a.split(b):d.isArray(a)||(a=[a]);b=a.length;var e=0;do a[e]&&k.push(h(a[e],c).hours(12));while(++e<b);return k};window.Kalendae=m;var d=m.util={isIE8:function(){return!(!/msie 8./i.test(navigator.appVersion)||/opera/i.test(navigator.userAgent)||!window.ActiveXObject||!XDomainRequest||window.msPerformance)},$:function(a){return"string"==typeof a?document.getElementById(a):a},$$:function(a){return document.querySelectorAll(a)},make:function(a,b,c){var d;a=document.createElement(a);if(b)for(d in b)b.hasOwnProperty(d)&&
a.setAttribute(d,b[d]);c&&c.appendChild(a);return a},isVisible:function(a){return 0<a.offsetWidth||0<a.offsetHeight},getStyle:function(a,b){var c;a.currentStyle?c=a.currentStyle[b]:window.getComputedStyle&&(c=window.getComputedStyle(a,null)[b]);return c},domReady:function(a){/in/.test(document.readyState)?setTimeout(function(){d.domReady(a)},9):a()},addEvent:function(a,b,c){var d=function(b){b=b||window.event;var d=c.apply(a,[b,b.target||b.srcElement]);!1===d&&(b.preventDefault?b.preventDefault():
(b.returnValue=!1,b.cancelBubble=!0));return d};a.attachEvent?a.attachEvent("on"+b,d):a.addEventListener(b,d,!1);return d},removeEvent:function(a,b,c){a.detachEvent?a.detachEvent("on"+b,c):a.removeEventListener(b,c,!1)},hasClassName:function(a,b){if(!(a=d.$(a)))return!1;var c=a.className;return 0<c.length&&(c==b||RegExp("(^|\\s)"+b+"(\\s|$)").test(c))},addClassName:function(a,b){(a=d.$(a))&&!d.hasClassName(a,b)&&(a.className+=(a.className?" ":"")+b)},removeClassName:function(a,b){if(a=d.$(a))a.className=
d.trimString(a.className.replace(RegExp("(^|\\s+)"+b+"(\\s+|$)")," "))},isFixed:function(a){do if("fixed"===d.getStyle(a,"position"))return!0;while(a=a.offsetParent);return!1},scrollContainer:function(a){do{var b=d.getStyle(a,"overflow");if("auto"===b||"scroll"===b)return a}while((a=a.parentNode)&&a!=window.document.body);return null},getPosition:function(a,b){var c=a.offsetLeft,d=a.offsetTop,e={};if(!b)for(;a=a.offsetParent;)c+=a.offsetLeft,d+=a.offsetTop;e[0]=e.left=c;e[1]=e.top=d;return e},getHeight:function(a){return a.offsetHeight||
...
typeof document.addEventListener&&m.util.domReady(function(){for(var a=d.$$(".auto-kal"),b=a.length,c,k;b--;)c=a[b],k=c.getAttribute("data-kal"),k=null==k||""==k?{}:(new Function("return {"+k+"};"))(),"INPUT"===c.tagName?new m.Input(c,k):new m(d.merge(k,{attachTo:c}))});m.Input=function(a,b){if("function"===typeof document.addEventListener||d.isIE8()){var c=this.input=d.$(a),k,e;if(!c||"INPUT"!==c.tagName)throw"First argument for Kalendae.Input must be an <input> element or a valid element id.";var f=
this,g=f.classes;e=f.settings=d.merge(f.defaults,b);e.attachTo=window.document.body;e.selected?k=!0:e.selected=c.value;m.call(f,e);e.closeButton&&(e=d.make("a",{"class":g.closeButton},f.container),d.addEvent(e,"click",function(){c.blur()}));k&&(c.value=f.getSelected());k=f.container;var h=!1;k.style.display="none";d.addClassName(k,g.positioned);d.addEvent(k,"mousedown",function(a,b){h=!0});d.addEvent(window.document,"mousedown",function(a,b){h=!1});d.addEvent(c,"focus",function(){f.setSelected(this.value);
f.show()});d.addEvent(c,"blur",function(){h&&d.isIE8()?(h=!1,c.focus()):f.hide()});d.addEvent(c,"keyup",function(a){f.setSelected(this.value)});(g=d.scrollContainer(c))&&d.addEvent(g,"scroll",function(a){c.blur()});f.subscribe("change",function(){c.value=f.getSelected()})}};m.Input.prototype=d.merge(m.prototype,{defaults:d.merge(m.prototype.defaults,{format:"MM/DD/YYYY",side:"bottom",closeButton:!0,offsetLeft:0,offsetTop:0}),classes:d.merge(m.prototype.classes,{positioned:"k-floating",closeButton:"k-btn-close"}),
show:function(){var a=this.container,b=a.style,c=this.input,k=d.getPosition(c),e=d.scrollContainer(c),e=e?e.scrollTop:0,f=this.settings;b.display="";switch(f.side){case "left":b.left=k.left-d.getWidth(a)+f.offsetLeft+"px";b.top=k.top+f.offsetTop-e+"px";break;case "right":b.left=k.left+d.getWidth(c)+"px";b.top=k.top+f.offsetTop-e+"px";break;case "top":b.left=k.left+f.offsetLeft+"px";b.top=k.top-d.getHeight(a)+f.offsetTop-e+"px";break;default:b.left=k.left+f.offsetLeft+"px",b.top=k.top+d.getHeight(c)+
f.offsetTop-e+"px"}b.position=d.isFixed(c)?"fixed":"absolute";this.publish("show",this)},hide:function(){this.container.style.display="none";this.publish("hide",this)}});var x=function(a){a||(a=this);var b=a.c_||{};a.publish=function(a,d,e){for(var f=(a=b[a])?a.length:0,g;f--;)if(g=a[f].apply(d,e||[]),"boolean"===typeof g)return g};a.subscribe=function(a,d,e){b[a]||(b[a]=[]);e?b[a].push(d):b[a].unshift(d);return[a,d]};a.unsubscribe=function(a){var d=b[a[0]];a=a[1];for(var e=d?d.length:0;e--;)d[e]===
a&&d.splice(e,1)}};if(!m.moment)if(window.moment)m.moment=window.moment;else throw"Kalendae requires moment.js. You must use kalendae.standalone.js if moment is not available on the page.";h=m.moment;h.fn.stripTime=function(){this._d=new Date(864E5*Math.floor(this._d.valueOf()/864E5));return this};h.fn.yearDay=function(a){var b=Math.floor(this._d/864E5);return"undefined"===typeof a?b:this.add({d:a-b})};q=m.moment().stripTime();"undefined"===typeof jQuery||"function"!==typeof document.addEventListener&&
!d.isIE8()||(jQuery.fn.kalendae=function(a){this.each(function(b,c){"INPUT"===c.tagName?$(c).data("kalendae",new m.Input(c,a)):$(c).data("kalendae",new m($.extend({},{attachTo:c},a)))});return this})})();
