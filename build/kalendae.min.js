...
j=0;do p=f.days[j],g=[],(o=this.isSelected(b))&&g.push({"-1":this.classes.dayInRange,1:this.classes.daySelected,"true":this.classes.daySelected}[o]),b.month()!=a.month()?g.push(this.classes.dayOutOfMonth):(!this.blackout(b)||0<o)&&g.push(this.classes.dayActive),0===Math.floor(d.diff(b,"days",!0))&&g.push(this.classes.dayToday),p.innerHTML=b.format(this.settings.dayNumberFormat),p.className=g.join(" "),p.setAttribute("data-date",b.format(this.settings.dayAttributeFormat)),b.add("days",1);while(42>
++j);a.add("months",1)}while(++n<e)};var e={isIE:/msie/.test(navigator.userAgent.toLowerCase()),$:function(a){return"string"==typeof a?document.getElementById(a):a},make:function(a,b){var d,f=document.createElement(a);if(b)for(d in b)b.hasOwnProperty(d)&&f.setAttribute(d,b[d]);return f},isVisible:function(a){return 0<a.offsetWidth||0<a.offsetHeight},addEvent:function(a,b,d){var f=function(b){b=b||window.event;return d.apply(a,[b,b.target||b.srcElement])};a.attachEvent?a.attachEvent("on"+b,f):a.addEventListener(b,
f,!1);return f},removeEvent:function(a,b,d){a.detachEvent?a.detachEvent("on"+b,d):a.removeEventListener(b,d,!1)},hasClassName:function(a,b){if(!(a=e.$(a)))return!1;var d=a.className;return 0<d.length&&(d==b||RegExp("(^|\\s)"+b+"(\\s|$)").test(d))},addClassName:function(a,b){if((a=e.$(a))&&!e.hasClassName(a,b))a.className+=(a.className?" ":"")+b},removeClassName:function(a,b){if(a=e.$(a))a.className=e.trimString(a.className.replace(RegExp("(^|\\s+)"+b+"(\\s+|$)")," "))},getTop:function(a,b){var d=
a.offsetTop;if(!b)for(;a=a.offsetParent;)d+=a.offsetTop;return d},getHeight:function(a){return a.offsetHeight||a.scrollHeight},getWidth:function(a){return a.offsetWidth||a.scrollWidth},trimString:function(a){return a.replace(/^\s+/,"").replace(/\s+$/,"")},merge:function(){for(var a=!0===arguments[0],b={},d=a?1:0;d<arguments.length;d++){var f=b,e=arguments[d];if("object"===typeof e){var g=void 0;for(g in e)e.hasOwnProperty(g)&&(a&&"object"===typeof f[g]&&"object"===typeof e[g]?_update(f[g],e[g]):f[g]=
e[g])}}return b},isArray:function(a){return!(!a||!a.length||0===a.length||"object"!==typeof a||!a.constructor||a.nodeType||a.item)}};MinPubSub=function(a){a||(a=this);var b=a.c_||{};a.publish=function(a,f,e){for(var g=(a=b[a])?a.length:0,n;g--;)if(n=a[g].apply(f,e||[]),"boolean"===typeof n)return n};a.subscribe=function(a,f,e){b[a]||(b[a]=[]);e?b[a].push(f):b[a].unshift(f);return[a,f]};a.unsubscribe=function(a){for(var f=b[a[0]],a=a[1],e=f?f.length:0;e--;)f[e]===a&&f.splice(e,1)}};(function(a,b){function d(a){this._d=
