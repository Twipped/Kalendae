...
(function(){var r,h,k=function(a,b){if("function"===typeof document.addEventListener||d.isIE8()){var c=!1;try{c=a instanceof Element}catch(j){c=!!a&&1===c.nodeType}c||"string"===typeof a||(b=a);var e=this,f=e.classes,g=e.settings=d.merge(e.defaults,{attachTo:a},b||{}),c=e.container=d.make("div",{"class":f.container}),k=e.calendars=[],p=h().day(g.weekStart),l,n=[],q,m,r;q=[];var t;m=0;l=g.months;d.isIE8()&&d.addClassName(c,"ie8");for(m=7;m--;)n.push(p.format(g.columnHeaderFormat)),p.add("days",1);
...
j,e,f,g=0,k,p=0,l,n=this.settings;k=this.calendars.length;do{b=h(a).date(1);b.day(b.day()<this.settings.weekStart?this.settings.weekStart-7:this.settings.weekStart);j=this.calendars[g];j.caption.innerHTML=a.format(this.settings.titleFormat);p=0;do e=j.days[p],f=[],(l=this.isSelected(b))&&f.push({"-1":c.dayInRange,1:c.daySelected,"true":c.daySelected}[l]),b.month()!=a.month()?f.push(c.dayOutOfMonth):f.push(c.dayInMonth),(!this.blackout(b)&&!(this.direction(b)||b.month()!=a.month()&&!1===n.dayOutOfMonthClickable)||
0<l)&&f.push(c.dayActive),b.yearDay()===r.yearDay()&&f.push(c.dayToday),l=b.format(this.settings.dayAttributeFormat),n.dateClassMap[l]&&f.push(n.dateClassMap[l]),e.innerHTML=b.format(n.dayNumberFormat),e.className=f.join(" "),e.setAttribute("data-date",l),b.add("days",1);while(42>++p);a.add("months",1)}while(++g<k);if(n.directionScrolling){if("today-past"===n.direction||"past"===n.direction)b=a.add({m:1}).diff(h(),"months",!0),0>=b?(this.disableNextMonth=!1,d.removeClassName(this.container,c.disableNextMonth)):
...
d.$$(".auto-kal"),b=a.length,c,j;b--;)c=a[b],j=c.getAttribute("data-kal"),j=null==j||""==j?{}:(new Function("return {"+j+"};"))(),"INPUT"===c.tagName?new k.Input(c,j):new k(d.merge(j,{attachTo:c}))});k.Input=function(a,b){if("function"===typeof document.addEventListener||d.isIE8()){var c=this.input=d.$(a),j,e,f=!1;if(!c||"INPUT"!==c.tagName)throw"First argument for Kalendae.Input must be an <input> element or a valid element id.";var g=this,h=g.classes;e=g.settings=d.merge(g.defaults,b);e.attachTo=
window.document.body;e.selected?j=!0:e.selected=c.value;k.call(g,e);e.closeButton&&(e=d.make("a",{"class":h.closeButton},g.container),d.addEvent(e,"click",function(){c.blur()}));j&&(c.value=g.getSelected());j=g.container;var p=!1;j.style.display="none";d.addClassName(j,h.positioned);d.addEvent(j,"mousedown",function(){p=!0});d.addEvent(window.document,"mousedown",function(){p=!1});d.addEvent(c,"focus",function(){f=!0;g.setSelected(this.value);f=!1;g.show()});d.addEvent(c,"blur",function(){p&&d.isIE8()?
(p=!1,c.focus()):g.hide()});d.addEvent(c,"keyup",function(){f=!0;g.setSelected(this.value);f=!1});(h=d.scrollContainer(c))&&d.addEvent(h,"scroll",function(){c.blur()});g.subscribe("change",function(){f||(c.value=g.getSelected())})}};k.Input.prototype=d.merge(k.prototype,{defaults:d.merge(k.prototype.defaults,{format:"MM/DD/YYYY",side:"bottom",closeButton:!0,offsetLeft:0,offsetTop:0}),classes:d.merge(k.prototype.classes,{positioned:"k-floating",closeButton:"k-btn-close"}),show:function(){var a=this.container,
b=a.style,c=this.input,j=d.getPosition(c),e=d.scrollContainer(c),e=e?e.scrollTop:0,f=this.settings;b.display="";switch(f.side){case "left":b.left=j.left-d.getWidth(a)+f.offsetLeft+"px";b.top=j.top+f.offsetTop-e+"px";break;case "right":b.left=j.left+d.getWidth(c)+"px";b.top=j.top+f.offsetTop-e+"px";break;case "top":b.left=j.left+f.offsetLeft+"px";b.top=j.top-d.getHeight(a)+f.offsetTop-e+"px";break;default:b.left=j.left+f.offsetLeft+"px",b.top=j.top+d.getHeight(c)+f.offsetTop-e+"px"}b.position=d.isFixed(c)?
