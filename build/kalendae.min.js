 ...
 *	Version 0.6.0                                                   *
 ********************************************************************/
(function(k){"function"===typeof define&&define.amd?define(["moment"],k):"object"===typeof exports?module.exports=k(require("moment")):window.Kalendae=k()})(function(k){var t=function(){return n.moment().startOf("day").yearDay()},n=function(a,b){if("function"===typeof document.addEventListener||e.isIE8()){var c=!1;try{c=a instanceof Element}catch(n){c=!!a&&1===c.nodeType}c||"string"===typeof a||(b=a);var d=this,g=d.classes,f=d.settings=e.merge(d.defaults,{attachTo:a},b||{}),c=d.container=e.make("div",
{"class":g.container}),h=d.calendars=[],r=k().day(f.weekStart),m,u=[],p,l,q,v,t;p=[];l=0;m=f.months;e.isIE8()&&e.addClassName(c,"ie8");for(l=7;l--;)u.push(r.format(f.columnHeaderFormat)),r.add(1,"days");y(d);if("object"===typeof f.subscribe)for(l in f.subscribe)f.subscribe.hasOwnProperty(l)&&d.subscribe(l,f.subscribe[l]);m=f.viewStartDate?k(f.viewStartDate,f.format):k();d.viewStartDate=m.date(1);d._sel=[];f.selected&&(d.setSelected(f.selected,!1),d.viewStartDate=k(d._sel[0]));(m={past:f.months-1,
"today-past":f.months-1,any:2<f.months?Math.floor(f.months/2):0,"today-future":0,future:0}[this.settings.direction])&&k().month()==k(d.viewStartDate).month()&&(d.viewStartDate=k(d.viewStartDate).subtract({M:m}).date(1));d.defaultView=k(d.viewStartDate);if("function"===typeof f.blackout)d.blackout=f.blackout;else if(f.blackout){var x=w(f.blackout,f.parseSplitDelimiter,f.format);d.blackout=function(a){a=k(a).startOf("day").yearDay();if(1>a||!d._sel)return!1;for(var c=x.length;c--;)if(x[c].startOf("day").yearDay()===
a)return!0;return!1}}else d.blackout=function(){return!1};d.direction=d.directions[f.direction]?d.directions[f.direction]:d.directions.any;for(m=Math.max(f.months,1);m--;){p=e.make("div",{"class":g.calendar},c);p.setAttribute("data-cal-index",m);1<f.months&&(m==Math.max(f.months-1,1)?e.addClassName(p,g.monthFirst):0===m?e.addClassName(p,g.monthLast):e.addClassName(p,g.monthMiddle));l=e.make("div",{"class":g.title},p);f.useYearNav||e.addClassName(l,g.disableYearNav);e.make("a",{"class":g.previousYear},
l);e.make("a",{"class":g.previousMonth},l);e.make("a",{"class":g.nextYear},l);e.make("a",{"class":g.nextMonth},l);r=e.make("span",{"class":g.caption},l);q=e.make("div",{"class":g.header+" "+(1==f.dayHeaderClickable?g.dayActive:"")},p);l=0;do v=e.make("span",{"data-day":l},q),1==f.dayHeaderClickable&&"multiple"==f.mode&&(v.addEventListener("mouseover",function(a){daysToHover=a.target.parentNode.nextSibling.getElementsByClassName("k-day-week-"+a.target.getAttribute("data-day"));if(0<daysToHover.length)for(a=
0;a<daysToHover.length;a++)e.hasClassName(daysToHover[a],g.dayActive)&&e.addClassName(daysToHover[a],"k-day-hover-active")}),v.addEventListener("mouseleave",function(a){daysToHover=a.target.parentNode.nextSibling.getElementsByClassName("k-day-week-"+a.target.getAttribute("data-day"));if(0<daysToHover.length)for(a=0;a<daysToHover.length;a++)e.hasClassName(daysToHover[a],g.dayActive)&&e.removeClassName(daysToHover[a],"k-day-hover-active")})),v.innerHTML=u[l];while(7>++l);v=e.make("div",{"class":g.days},
p);l=0;p=[];do"week"==f.mode?(0===l%7&&(t=e.make("div",{"class":g.week+" clearfix"},v),p.push(t)),e.make("span",{},t)):p.push(e.make("span",{},v));while(42>++l);h.push({header:q,caption:r,days:p});m&&e.make("div",{"class":g.monthSeparator},c)}d.draw();e.addEvent(c,"mousedown",function(a,c){var b;if(e.hasClassName(c,g.nextMonth))d.disableNext||!1===d.publish("view-changed",d,["next-month"])||(d.viewStartDate.add(1,"months"),d.draw());else if(e.hasClassName(c,g.previousMonth))d.disablePreviousMonth||
!1===d.publish("view-changed",d,["previous-month"])||(d.viewStartDate.subtract(1,"months"),d.draw());else if(e.hasClassName(c,g.nextYear))d.disableNext||!1===d.publish("view-changed",d,["next-year"])||(d.viewStartDate.add(1,"years"),d.draw());else if(e.hasClassName(c,g.previousYear))d.disablePreviousMonth||!1===d.publish("view-changed",d,["previous-year"])||(d.viewStartDate.subtract(1,"years"),d.draw());else if((e.hasClassName(c.parentNode,g.days)||e.hasClassName(c.parentNode,g.week))&&e.hasClassName(c,
g.dayActive)&&(b=c.getAttribute("data-date"))){if(b=k(b,f.dayAttributeFormat).hours(12),!1!==d.publish("date-clicked",d,[b]))switch(f.mode){case "multiple":d.addSelected(b)||d.removeSelected(b);break;case "range":d.addSelected(b);break;case "week":d.weekSelected(b);break;default:d.addSelected(b)}}else if(e.hasClassName(c.parentNode,g.week)&&(b=c.getAttribute("data-date")))b=k(b,f.dayAttributeFormat).hours(12),!1!==d.publish("date-clicked",d,[b])&&"week"==f.mode&&d.weekSelected(b);else if(e.hasClassName(c.parentNode,
...
disablePreviousMonth:!1,disableNextMonth:!1,disablePreviousYear:!1,disableNextYear:!1,directions:{past:function(a){return k(a).startOf("day").yearDay()>=t()},"today-past":function(a){return k(a).startOf("day").yearDay()>t()},any:function(a){return!1},"today-future":function(a){return k(a).startOf("day").yearDay()<t()},future:function(a){return k(a).startOf("day").yearDay()<=t()}},getSelectedAsDates:function(){for(var a=[],b=0,c=this._sel.length;b<c;b++)a.push(this._sel[b].toDate());return a},getSelectedAsText:function(a){for(var b=
[],c=0,d=this._sel.length;c<d;c++)b.push(this._sel[c].format(a||this.settings.format||"YYYY-MM-DD"));return b},getSelectedRaw:function(){for(var a=[],b=0,c=this._sel.length;b<c;b++)a.push(k(this._sel[b]));return a},getSelected:function(a){a=this.getSelectedAsText(a);switch(this.settings.mode){case "week":case "range":return a.splice(2),a.join(this.settings.rangeDelimiter);case "multiple":return a.join(this.settings.multipleDelimiter);default:return a[0]||null}},isSelected:function(a){a=k(a).startOf("day").yearDay();
...
this._sel.push(a);break;case "range":1!==this._sel.length?this._sel=[a]:a.startOf("day").yearDay()>this._sel[0].startOf("day").yearDay()?this._sel[1]=a:this._sel=[a,this._sel[0]];break;default:this._sel=[a]}this._sel.sort(function(a,b){return a.startOf("day").yearDay()-b.startOf("day").yearDay()});this.publish("change",this,[a]);!1!==b&&this.draw();return!0},weekSelected:function(a){var b=a.toDate(),c=k(b).startOf("week"),b=k(b).endOf("week").subtract(1,"day");this._sel=[c,b];this.publish("change",
this,[a.day()]);this.draw()},monthDaySelected:function(a,b,c){b=k(a).startOf("month").weekday(b);var d=k(a).endOf("month");for(selected=[];b<=d;)b>=k(a).startOf("month")&&!this.direction(b)&&(c?this.removeSelected(k(b).hours(12)):this.addSelected(k(b).hours(12))),b.add(7,"d")},makeSelectedDateVisible:function(a){outOfViewMonth=k(a).date("1").diff(this.viewStartDate,"months");0>outOfViewMonth?this.viewStartDate.subtract(1,"months"):0<outOfViewMonth&&outOfViewMonth>=this.settings.months&&this.viewStartDate.add(1,
"months")},removeSelected:function(a,b){a=k(a,this.settings.format).hours(12);for(var c=this._sel.length;c--;)if(this._sel[c].startOf("day").yearDay()===a.startOf("day").yearDay())return this._sel.splice(c,1),this.publish("change",this,[a]),!1!==b&&this.draw(),!0;return!1},draw:function(){var a=k(this.viewStartDate).startOf("day").add(12,"hours"),b,c=this.classes,d,g,f,h=0,r,m=0;b=0;var u,p,l,q=this.settings;r=this.calendars.length;do{b=k(a).date(1);b.day(b.day()<this.settings.weekStart?this.settings.weekStart-
7:this.settings.weekStart);d=this.calendars[h];d.header.parentNode.setAttribute("data-datestart",a.format(this.settings.dayAttributeFormat));d.caption.innerHTML=a.format(this.settings.titleFormat);u=m=0;l=[];for(g=0;7>g;g++)e.removeClassName(d.header.children[g],c.daySelected),l[g]=0;do"week"==q.mode?(0===m%7&&0!==m&&u++,g=d.days[u].childNodes[m%7]):g=d.days[m],f=[],(p=this.isSelected(b))&&f.push({"-1":c.dayInRange,1:c.daySelected,"true":c.daySelected}[p]),"range"===q.mode&&(this._sel[0]&&this._sel[0].startOf("day").yearDay()===
b.clone().startOf("day").yearDay()&&f.push(c.dayInRangeStart),this._sel[1]&&this._sel[1].startOf("day").yearDay()===b.clone().startOf("day").yearDay()&&f.push(c.dayInRangeEnd)),q.dayHeaderClickable&&"multiple"===q.mode&&(f.push("k-day-week-"+b.weekday()),1!=p&&1!=p||this.direction(b)||a.format("M")!=b.format("M")||(l[b.weekday()]=l[b.weekday()]+1)),b.month()!=a.month()?f.push(c.dayOutOfMonth):f.push(c.dayInMonth),(!(this.blackout(b)||this.direction(b)||b.month()!=a.month()&&!1===q.dayOutOfMonthClickable)||
0<p)&&f.push(c.dayActive),b.clone().startOf("day").yearDay()===t()&&f.push(c.dayToday),p=b.format(this.settings.dayAttributeFormat),q.dateClassMap[p]&&f.push(q.dateClassMap[p]),g.innerHTML=b.format(q.dayNumberFormat),g.className=f.join(" "),g.setAttribute("data-date",p),b.add(1,"days");while(42>++m);g=0;if(0<l.length){do if(0<l[g]){m=n.moment(a).startOf("month").weekday(g);u=n.moment(a).startOf("month");endMonth=n.moment(a).endOf("month");b=0;do m>=u&&!this.direction(m)&&b++,m.add(7,"d");while(m<=
endMonth);b==l[g]?e.addClassName(d.header.children[g],c.daySelected):e.removeClassName(d.header.children[g],c.daySelected)}while(++g<l.length)}a.add(1,"months")}while(++h<r);if(q.directionScrolling){d=k().startOf("day").hours(12);a=a.diff(d,"months",!0);if("today-past"===q.direction||"past"===q.direction)0>=a?(this.disableNextMonth=!1,e.removeClassName(this.container,c.disableNextMonth)):(this.disableNextMonth=!0,e.addClassName(this.container,c.disableNextMonth));else if("today-future"===q.direction||
"future"===q.direction)a>q.months?(this.disablePreviousMonth=!1,e.removeClassName(this.container,c.disablePreviousMonth)):(this.disablePreviousMonth=!0,e.addClassName(this.container,c.disablePreviousMonth));if("today-past"===q.direction||"past"===q.direction)-11>=a?(this.disableNextYear=!1,e.removeClassName(this.container,c.disableNextYear)):(this.disableNextYear=!0,e.addClassName(this.container,c.disableNextYear));else if("today-future"===q.direction||"future"===q.direction)a>11+q.months?(this.disablePreviousYear=
!1,e.removeClassName(this.container,c.disablePreviousYear)):(this.disablePreviousYear=!0,e.addClassName(this.container,c.disablePreviousYear))}}};var w=function(a,b,c){var d=[];"string"===typeof a?a=a.split(b):e.isArray(a)||(a=[a]);b=a.length;var g=0,f;do a[g]&&(f=k(a[g],c).hours(12),f.isValid()&&d.push(f));while(++g<b);return d};window.Kalendae=n;var e=n.util={isIE8:function(){return!(!/msie 8./i.test(navigator.appVersion)||/opera/i.test(navigator.userAgent)||!window.ActiveXObject||!XDomainRequest||
...
n.util.domReady(function(){for(var a=e.$$(".auto-kal"),b=a.length,c,d;b--;)c=a[b],d=c.getAttribute("data-kal"),d=null==d||""==d?{}:(new Function("return {"+d+"};"))(),"INPUT"===c.tagName?new n.Input(c,d):new n(e.merge(d,{attachTo:c}))});n.Input=function(a,b){if("function"===typeof document.addEventListener||e.isIE8()){var c=this.input=e.$(a),d,g,f=!1;if(!c||"INPUT"!==c.tagName)throw"First argument for Kalendae.Input must be an <input> element or a valid element id.";var h=this,r=h.classes;g=h.settings=
e.merge(h.defaults,b);this._events={};g.attachTo=window.document.body;g.selected?d=!0:g.selected=c.value;n.call(h,g);g.closeButton&&(g=e.make("a",{"class":r.closeButton},h.container),e.addEvent(g,"click",function(){c.blur()}));d&&(c.value=h.getSelected());d=h.container;var m=!1;d.style.display="none";e.addClassName(d,r.positioned);this._events.containerMouseDown=e.addEvent(d,"mousedown",function(a,b){m=!0});this._events.documentMousedown=e.addEvent(window.document,"mousedown",function(a,b){m=!1});
this._events.inputFocus=e.addEvent(c,"focus",function(){f=!0;h.setSelected(this.value);f=!1;h.show()});this._events.inputBlur=e.addEvent(c,"blur",function(){m&&e.isIE8()?(m=!1,c.focus()):h.hide()});this._events.inputKeyup=e.addEvent(c,"keyup",function(a){f=!0;(a=w(this.value,h.settings.parseSplitDelimiter,h.settings.format))&&a.length&&a[0]&&1E3<a[0].year()?h.setSelected(this.value):(h.setSelected("",null),h.viewStartDate=k(h.defaultView),h.draw());f=!1});(r=e.scrollContainer(c))&&e.addEvent(r,"scroll",
function(a){c.blur()});h.subscribe("change",function(){f||(c.value=h.getSelected(),e.fireEvent(c,"change"))})}};n.Input.prototype=e.merge(n.prototype,{defaults:e.merge(n.prototype.defaults,{format:"MM/DD/YYYY",side:"bottom",closeButton:!0,offsetLeft:0,offsetTop:0}),classes:e.merge(n.prototype.classes,{positioned:"k-floating",closeButton:"k-btn-close"}),show:function(){var a=this.container,b=a.style,c=this.input,d=e.getPosition(c),g=e.scrollContainer(c),f=g?g.scrollTop:0,g=g?g.scrollLeft:0,h=this.settings;
b.display="";switch(h.side){case "left":b.left=d.left-e.getWidth(a)+h.offsetLeft-g+"px";b.top=d.top+h.offsetTop-f+"px";break;case "right":b.left=d.left+e.getWidth(c)-g+"px";b.top=d.top+h.offsetTop-f+"px";break;case "top":b.left=d.left+h.offsetLeft-g+"px";b.top=d.top-e.getHeight(a)+h.offsetTop-f+"px";break;case "bottom right":b.left=d.left-e.getWidth(a)+e.getWidth(c)+h.offsetLeft+"px";b.top=d.top+e.getHeight(c)+h.offsetTop-f+"px";break;default:b.left=d.left+h.offsetLeft-g+"px",b.top=d.top+e.getHeight(c)+
h.offsetTop-f+"px"}b.position=e.isFixed(c)?"fixed":"absolute";this.publish("show",this)},hide:function(){this.container.style.display="none";this.publish("hide",this)},destroy:function(){var a=this.container,b=this.input;e.removeEvent(a,"mousedown",this._events.containerMousedown);e.removeEvent(window.document,"mousedown",this._events.documentMousedown);e.removeEvent(b,"focus",this._events.inputFocus);e.removeEvent(b,"blur",this._events.inputBlur);e.removeEvent(b,"keyup",this._events.inputKeyup);
a.parentNode&&a.parentNode.removeChild(a)}});var y=function(a){a||(a=this);var b=a.c_||{};a.publish=function(a,d,e){for(var f=(a=b[a])?a.length:0,h;f--;)if(h=a[f].apply(d,e||[]),"boolean"===typeof h)return h};a.subscribe=function(a,d,e){b[a]||(b[a]=[]);e?b[a].push(d):b[a].unshift(d);return[a,d]};a.unsubscribe=function(a){var d=b[a[0]];a=a[1];for(var e=d?d.length:0;e--;)d[e]===a&&d.splice(e,1)}};"undefined"!==typeof k&&(n.moment=k);if(!n.moment)if(window.moment)n.moment=window.moment;else throw"Kalendae requires moment.js. You must use kalendae.standalone.js if moment is not available on the page.";
k=n.moment;k.fn.yearDay=function(a){var b=Math.floor(this._d/864E5);return"undefined"===typeof a?b:this.add({d:a-b})};"undefined"===typeof jQuery||"function"!==typeof document.addEventListener&&!e.isIE8()||(jQuery.fn.kalendae=function(a){this.each(function(b,c){"INPUT"===c.tagName?jQuery(c).data("kalendae",new n.Input(c,a)):jQuery(c).data("kalendae",new n(jQuery.extend({},{attachTo:c},a)))});return this});return n});
