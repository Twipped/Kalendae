...
ordinal:function(a){var b=a%10;return 1===~~(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th"}});h.isMoment=function(a){return a instanceof u};h.fn=u.prototype={clone:function(){return h(this)},valueOf:function(){return+this._d},"native":function(){return this._d},toString:function(){return this._d.toString()},toDate:function(){return this._d},utc:function(){this._isUTC=!0;return this},local:function(){this._isUTC=!1;return this},format:function(a){return z(this,a?a:h.defaultFormat)},add:function(a,
b){this._d=F(this._d,a,1,b);return this},subtract:function(a,b){this._d=F(this._d,a,-1,b);return this},diff:function(a,b,c){var a=h(a),e=6E4*(this.zone()-a.zone()),e=this._d-a._d-e,d=this.year()-a.year(),f=this.month()-a.month(),a=this.date()-a.date(),b="months"===b?12*d+f+a/30:"years"===b?d+f/12:"seconds"===b?e/1E3:"minutes"===b?e/6E4:"hours"===b?e/36E5:"days"===b?e/864E5:"weeks"===b?e/6048E5:e;return c?b:s(b)},from:function(a,b){return h.humanizeDuration(this.diff(a),!b)},fromNow:function(a){return this.from(h(),
...
"undefined"!==typeof jQuery&&"function"===typeof document.addEventListener&&(jQuery.fn.kalendae=function(a){this.each(function(b,c){"INPUT"===c.tagName?$(c).data("kalendae",new q.Input(c,a)):$(c).data("kalendae",new q($.extend({},{attachTo:c},a)))});return this})})();
