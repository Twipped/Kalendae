...
h(d[0],this.settings.format)),this.draw())},addSelected:function(a,b){a=h(a,this.settings.format).hours(12);this.settings.dayOutOfMonthClickable&&"range"!==this.settings.mode&&this.makeSelectedDateVisible(a);switch(this.settings.mode){case "multiple":if(this.isSelected(a))return!1;this._sel.push(a);break;case "range":1!==this._sel.length?this._sel=[a]:a.startOf("day").yearDay()>this._sel[0].startOf("day").yearDay()?this._sel[1]=a:this._sel=[a,this._sel[0]];break;default:this._sel=[a]}this._sel.sort(function(a,
...
else if("today-future"===l.direction||"future"===l.direction)a>11+l.months?(this.disablePreviousYear=!1,d.removeClassName(this.container,c.disablePreviousYear)):(this.disablePreviousYear=!0,d.addClassName(this.container,c.disablePreviousYear))}}};var u=function(a,b,c){var k=[];"string"===typeof a?a=a.split(b):d.isArray(a)||(a=[a]);b=a.length;var e=0;do a[e]&&k.push(h(a[e],c).hours(12));while(++e<b);return k};window.Kalendae=m;var d=m.util={isIE8:function(){return!(!/msie 8./i.test(navigator.appVersion)||
...
b,c):a.removeEventListener(b,c,!1)},hasClassName:function(a,b){if(!(a=d.$(a)))return!1;var c=a.className;return 0<c.length&&(c==b||RegExp("(^|\\s)"+b+"(\\s|$)").test(c))},addClassName:function(a,b){(a=d.$(a))&&!d.hasClassName(a,b)&&(a.className+=(a.className?" ":"")+b)},removeClassName:function(a,b){if(a=d.$(a))a.className=d.trimString(a.className.replace(RegExp("(^|\\s+)"+b+"(\\s+|$)")," "))},isFixed:function(a){do if("fixed"===d.getStyle(a,"position"))return!0;while(a=a.offsetParent);return!1},
scrollContainer:function(a){do{var b=d.getStyle(a,"overflow");if("auto"===b||"scroll"===b)return a}while((a=a.parentNode)&&a!=window.document.body);return null},getPosition:function(a,b){var c=a.offsetLeft,d=a.offsetTop,e={};if(!b)for(;a=a.offsetParent;)c+=a.offsetLeft,d+=a.offsetTop;e[0]=e.left=c;e[1]=e.top=d;return e},getHeight:function(a){return a.offsetHeight||a.scrollHeight},getWidth:function(a){return a.offsetWidth||a.scrollWidth},trimString:function(a){return a.replace(/^\s+/,"").replace(/\s+$/,
"")},merge:function(){for(var a=!0===arguments[0],b={},c=a?1:0;c<arguments.length;c++){var d=b,e=arguments[c];if("object"===typeof e){var f=void 0;for(f in e)e.hasOwnProperty(f)&&(a&&"object"===typeof d[f]&&"object"===typeof e[f]?_update(d[f],e[f]):d[f]=e[f])}}return b},isArray:function(a){return"[object Array]"==Object.prototype.toString.call(a)}};"function"===typeof document.addEventListener&&m.util.domReady(function(){for(var a=d.$$(".auto-kal"),b=a.length,c,k;b--;)c=a[b],k=c.getAttribute("data-kal"),
k=null==k||""==k?{}:(new Function("return {"+k+"};"))(),"INPUT"===c.tagName?new m.Input(c,k):new m(d.merge(k,{attachTo:c}))});m.Input=function(a,b){if("function"===typeof document.addEventListener||d.isIE8()){var c=this.input=d.$(a),k,e,f=!1;if(!c||"INPUT"!==c.tagName)throw"First argument for Kalendae.Input must be an <input> element or a valid element id.";var g=this,h=g.classes;e=g.settings=d.merge(g.defaults,b);this._events={};e.attachTo=window.document.body;e.selected?k=!0:e.selected=c.value;
m.call(g,e);e.closeButton&&(e=d.make("a",{"class":h.closeButton},g.container),d.addEvent(e,"click",function(){c.blur()}));k&&(c.value=g.getSelected());k=g.container;var p=!1;k.style.display="none";d.addClassName(k,h.positioned);this._events.containerMouseDown=d.addEvent(k,"mousedown",function(a,c){p=!0});this._events.documentMousedown=d.addEvent(window.document,"mousedown",function(a,c){p=!1});this._events.inputFocus=d.addEvent(c,"focus",function(){f=!0;g.setSelected(this.value);f=!1;g.show()});this._events.inputBlur=
d.addEvent(c,"blur",function(){p&&d.isIE8()?(p=!1,c.focus()):g.hide()});this._events.inputKeyup=d.addEvent(c,"keyup",function(a){f=!0;g.setSelected(this.value);f=!1});(h=d.scrollContainer(c))&&d.addEvent(h,"scroll",function(a){c.blur()});g.subscribe("change",function(){f||(c.value=g.getSelected())})}};m.Input.prototype=d.merge(m.prototype,{defaults:d.merge(m.prototype.defaults,{format:"MM/DD/YYYY",side:"bottom",closeButton:!0,offsetLeft:0,offsetTop:0}),classes:d.merge(m.prototype.classes,{positioned:"k-floating",
closeButton:"k-btn-close"}),show:function(){var a=this.container,b=a.style,c=this.input,k=d.getPosition(c),e=d.scrollContainer(c),e=e?e.scrollTop:0,f=this.settings;b.display="";switch(f.side){case "left":b.left=k.left-d.getWidth(a)+f.offsetLeft+"px";b.top=k.top+f.offsetTop-e+"px";break;case "right":b.left=k.left+d.getWidth(c)+"px";b.top=k.top+f.offsetTop-e+"px";break;case "top":b.left=k.left+f.offsetLeft+"px";b.top=k.top-d.getHeight(a)+f.offsetTop-e+"px";break;default:b.left=k.left+f.offsetLeft+"px",
b.top=k.top+d.getHeight(c)+f.offsetTop-e+"px"}b.position=d.isFixed(c)?"fixed":"absolute";this.publish("show",this)},hide:function(){this.container.style.display="none";this.publish("hide",this)},destroy:function(){var a=this.input;d.removeEvent(this.container,"mousedown",this._events.containerMousedown);d.removeEvent(window.document,"mousedown",this._events.documentMousedown);d.removeEvent(a,"focus",this._events.inputFocus);d.removeEvent(a,"blur",this._events.inputBlur);d.removeEvent(a,"keyup",this._events.inputKeyup)}});
var x=function(a){a||(a=this);var b=a.c_||{};a.publish=function(a,d,e){for(var f=(a=b[a])?a.length:0,g;f--;)if(g=a[f].apply(d,e||[]),"boolean"===typeof g)return g};a.subscribe=function(a,d,e){b[a]||(b[a]=[]);e?b[a].push(d):b[a].unshift(d);return[a,d]};a.unsubscribe=function(a){var d=b[a[0]];a=a[1];for(var e=d?d.length:0;e--;)d[e]===a&&d.splice(e,1)}};if(!m.moment)if(window.moment)m.moment=window.moment;else throw"Kalendae requires moment.js. You must use kalendae.standalone.js if moment is not available on the page.";
h=m.moment;h.fn.yearDay=function(a){var b=Math.floor(this._d/864E5);return"undefined"===typeof a?b:this.add({d:a-b})};r=m.moment().startOf("day");"undefined"===typeof jQuery||"function"!==typeof document.addEventListener&&!d.isIE8()||(jQuery.fn.kalendae=function(a){this.each(function(b,c){"INPUT"===c.tagName?$(c).data("kalendae",new m.Input(c,a)):$(c).data("kalendae",new m($.extend({},{attachTo:c},a)))});return this})})();
