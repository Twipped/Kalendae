...
(function(){var t,q=function(a,b){if("function"===typeof document.addEventListener){var c=!1;try{c=a instanceof Element}catch(e){c=!!a&&1===c.nodeType}c||"string"===typeof a||(b=a);var d=this,g=d.classes,l=d.settings=f.merge(d.defaults,{attachTo:a},b||{}),c=d.container=f.make("div",{"class":g.container}),h=d.calendars=[],w=j().day(l.weekStart),n,o=[],m,k,x;m=[];var p;k=0;n=l.months;f.isIE8()&&f.addClassName(c,"ie8");for(k=7;k--;)o.push(w.format("ddd").substr(0,l.columnHeaderLength)),w.add("days",
