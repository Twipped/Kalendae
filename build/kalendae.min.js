...
d,e,r,j=0,D,m=0,n,f=this.settings;D=this.calendars.length;do{b=h(a).date(1);b.day(b.day()<this.settings.weekStart?this.settings.weekStart-7:this.settings.weekStart);d=this.calendars[j];d.caption.innerHTML=a.format(this.settings.titleFormat);m=0;do e=d.days[m],r=[],(n=this.isSelected(b))&&r.push({"-1":c.dayInRange,1:c.daySelected,"true":c.daySelected}[n]),b.month()!=a.month()?r.push(c.dayOutOfMonth):(!this.blackout(b)&&!this.direction(b)||0<n)&&r.push(c.dayActive),b.yearDay()===l.yearDay()&&r.push(c.dayToday),
