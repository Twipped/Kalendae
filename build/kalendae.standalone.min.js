...
(function(){var t,k,m=function(a,b){if("function"===typeof document.addEventListener||c.isIE8()){var d=!1;try{d=a instanceof Element}catch(l){d=!!a&&1===d.nodeType}d||"string"===typeof a||(b=a);var e=this,g=e.classes,j=e.settings=c.merge(e.defaults,{attachTo:a},b||{}),d=e.container=c.make("div",{"class":g.container}),m=e.calendars=[],v=k().day(j.weekStart),n,p=[],r,q,z;r=[];var t;q=0;n=j.months;c.isIE8()&&c.addClassName(d,"ie8");for(q=7;q--;)p.push(v.format(j.columnHeaderFormat)),v.add("days",1);
...
if("function"===typeof j.blackout)e.blackout=j.blackout;else if(j.blackout){var A=w(j.blackout,j.parseSplitDelimiter);e.blackout=function(a){a=k(a).yearDay();if(1>a||!e._sel)return!1;for(var d=A.length;d--;)if(A[d].yearDay()===a)return!0;return!1}}else e.blackout=function(){return!1};e.direction=e.directions[j.direction]?e.directions[j.direction]:e.directions.any;for(n=Math.max(j.months,1);n--;){r=c.make("div",{"class":g.calendar},d);r.setAttribute("data-cal-index",n);1<j.months&&(n==Math.max(j.months-
1,1)?c.addClassName(r,g.monthFirst):0===n?c.addClassName(r,g.monthLast):c.addClassName(r,g.monthMiddle));q=c.make("div",{"class":g.title},r);j.useYearNav||c.addClassName(q,g.disableYearNav);c.make("a",{"class":g.previousYear},q);c.make("a",{"class":g.previousMonth},q);c.make("a",{"class":g.nextYear},q);c.make("a",{"class":g.nextMonth},q);v=c.make("span",{"class":g.caption},q);z=c.make("div",{"class":g.header},r);q=0;do t=c.make("span",{},z),t.innerHTML=p[q];while(7>++q);z=c.make("div",{"class":g.days},
...
"months");0>outOfViewMonth?this.viewStartDate.subtract("months",1):0<outOfViewMonth&&outOfViewMonth>=this.settings.months&&this.viewStartDate.add("months",1)},removeSelected:function(a,b){a=k(a).hours(12);for(var d=this._sel.length;d--;)if(this._sel[d].yearDay()===a.yearDay())return this._sel.splice(d,1),this.publish("change",this,[a]),!1!==b&&this.draw(),!0;return!1},draw:function(){var a=k(this.viewStartDate).hours(12),b,d=this.classes,l,e,g,j=0,m,v=0,n,p=this.settings;m=this.calendars.length;do{b=
k(a).date(1);b.day(b.day()<this.settings.weekStart?this.settings.weekStart-7:this.settings.weekStart);l=this.calendars[j];l.caption.innerHTML=a.format(this.settings.titleFormat);v=0;do e=l.days[v],g=[],(n=this.isSelected(b))&&g.push({"-1":d.dayInRange,1:d.daySelected,"true":d.daySelected}[n]),b.month()!=a.month()?g.push(d.dayOutOfMonth):g.push(d.dayInMonth),(!this.blackout(b)&&!(this.direction(b)||b.month()!=a.month()&&!1===p.dayOutOfMonthClickable)||0<n)&&g.push(d.dayActive),b.yearDay()===t.yearDay()&&
g.push(d.dayToday),n=b.format(this.settings.dayAttributeFormat),p.dateClassMap[n]&&g.push(p.dateClassMap[n]),e.innerHTML=b.format(p.dayNumberFormat),e.className=g.join(" "),e.setAttribute("data-date",n),b.add("days",1);while(42>++v);a.add("months",1)}while(++j<m);if(p.directionScrolling){if("today-past"===p.direction||"past"===p.direction)b=a.add({m:1}).diff(k(),"months",!0),0>=b?(this.disableNextMonth=!1,c.removeClassName(this.container,d.disableNextMonth)):(this.disableNextMonth=!0,c.addClassName(this.container,
d.disableNextMonth));else if("today-future"===p.direction||"future"===p.direction)b=a.subtract({m:1}).diff(k(),"months",!0),b>p.months?(this.disablePreviousMonth=!1,c.removeClassName(this.container,d.disablePreviousMonth)):(this.disablePreviousMonth=!0,c.addClassName(this.container,d.disablePreviousMonth));if("today-past"===p.direction||"past"===p.direction)b=a.add({m:12}).diff(k(),"months",!0),-11>=b?(this.disableNextYear=!1,c.removeClassName(this.container,d.disableNextYear)):(this.disableNextYear=
!0,c.addClassName(this.container,d.disableNextYear));else if("today-future"===p.direction||"future"===p.direction)b=a.subtract({m:12}).diff(k(),"months",!0),b>11+p.months?(this.disablePreviousYear=!1,c.removeClassName(this.container,d.disablePreviousYear)):(this.disablePreviousYear=!0,c.addClassName(this.container,d.disablePreviousYear))}}};var w=function(a,b,d){var l=[];"string"===typeof a?a=a.split(b):c.isArray(a)||(a=[a]);b=a.length;var e=0;do a[e]&&l.push(k(a[e],d).hours(12));while(++e<b);return l};
window.Kalendae=m;var c=m.util={isIE8:function(){return!(!/msie 8./i.test(navigator.appVersion)||/opera/i.test(navigator.userAgent)||!window.ActiveXObject||!XDomainRequest||window.msPerformance)},$:function(a){return"string"==typeof a?document.getElementById(a):a},$$:function(a){return document.querySelectorAll(a)},make:function(a,b,d){var c;a=document.createElement(a);if(b)for(c in b)b.hasOwnProperty(c)&&a.setAttribute(c,b[c]);d&&d.appendChild(a);return a},isVisible:function(a){return 0<a.offsetWidth||
0<a.offsetHeight},getStyle:function(a,b){var d;a.currentStyle?d=a.currentStyle[b]:window.getComputedStyle&&(d=window.getComputedStyle(a,null)[b]);return d},domReady:function(a){/in/.test(document.readyState)?setTimeout(function(){c.domReady(a)},9):a()},addEvent:function(a,b,d){var c=function(b){b=b||window.event;var c=d.apply(a,[b,b.target||b.srcElement]);!1===c&&(b.preventDefault?b.preventDefault():(b.returnValue=!1,b.cancelBubble=!0));return c};a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener(b,
...
h=e._a;switch(a[d]){case "M":case "MM":h[1]=null==c?0:~~c-1;break;case "MMM":case "MMMM":g=r(e._l).monthsParse(c);null!=g?h[1]=g:e._isValid=!1;break;case "D":case "DD":case "DDD":case "DDDD":null!=c&&(h[2]=~~c);break;case "YY":h[0]=~~c+(68<~~c?1900:2E3);break;case "YYYY":case "YYYYY":h[0]=~~c;break;case "a":case "A":e._isPm="pm"===(c+"").toLowerCase();break;case "H":case "HH":case "h":case "hh":h[3]=~~c;break;case "m":case "mm":h[4]=~~c;break;case "s":case "ss":h[5]=~~c;break;case "S":case "SS":case "SSS":h[6]=
